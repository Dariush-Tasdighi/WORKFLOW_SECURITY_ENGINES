namespace Models.Workflow
{
	[System.ComponentModel.DataAnnotations.Schema.Table
		(name: Infrastructure.Constants.WORKFLOW_TABLE_NAME_OF_ACTIVITY_TYPE,
	...
	public class ActivityType :
		...
		Models.Infrastructure.ICode<Enums.ActivityTypes>
	{
		#region Configuration
		internal class Configuration :
			System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<ActivityType>
		{
		...
		// **********
		public Enums.ActivityTypes CodeEnum
		{
			get
			{
				return ((Enums.ActivityTypes)Code);
			}
		}
		// **********
		// **********
