namespace Models.Workflow
{
	[System.ComponentModel.DataAnnotations.Schema.Table
		(name: Infrastructure.Constants.WORKFLOW_TABLE_NAME_OF_STATE,
		Schema = Infrastructure.Constants.WORKFLOW_SCHEMA_NAME)]
	public class State : Models.Infrastructure.BaseExtendedEntity
	{
		...
		[System.ComponentModel.DataAnnotations.Display
			(ResourceType = typeof(Resources.Models.Workflow.StateType),
			Name = Resources.Models.Workflow.Strings.StateTypeKeys.EntityName)]

		[System.ComponentModel.DataAnnotations.Required
			(ErrorMessageResourceType = typeof(Resources.Messages),
			ErrorMessageResourceName = Resources.Strings.MessagesKeys.Required)]
		public System.Guid StateTypeId { get; set; }
		// **********
