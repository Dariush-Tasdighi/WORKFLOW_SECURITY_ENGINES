namespace Dtx
{
	public static class Math
	{
		...
		{
			return (GetRemainder(GetRemainder(numerator, denominator) + denominator, denominator));
		}
		...
		{
			int intReminder = 0;
			int intQuotient = DivRem(a, b, out intReminder);
		...
		{
			long lngReminder = 0;
			long lngQuotient = DivRem(a, b, out lngReminder);
